      ...
      <div className="max-w-2xl mx-auto px-6 py-10 space-y-6">
        ...
        <div className="card p-6">
          ...
          {!isPro && (
            <div className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-200 rounded-lg mb-4">
              ...
              <div>
                ...
                <a href="/dashboard/plans" className="inline-block mt-2 text-xs font-bold text-amber-800 underline">
                  Ver planos →
                </a>
              </div>
            </div>
          ...
          <div className="mb-5">
            ...
            <form action={saveWhatsAppNumber} className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 text-sm border border-border rounded-lg bg-white text-ink focus:outline-none focus:border-forest"
              />
              <button
                type="submit"
          ...
          <a
            ...
            style={{ backgroundColor: isPro ? "#25D366" : "#2D4A3E" }}
          >
